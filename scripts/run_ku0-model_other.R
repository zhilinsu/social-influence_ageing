...
for (pop_value in pop_vec) {
	...
	model_file <- "scripts/stan_model/ku-model_other_0.stan"
	...
	for (o_block in c("i", "p")) { # other blocks 
		...
		if (pop == 0) {
			file_name <- paste("stanfit_ku0_other_", o_block, ".rds", sep = "")
		} else if (pop == 1) {
			file_name <- paste("stanfit_ku0_ya_other_", o_block, ".rds", sep = "")
		} else if (pop == 2) {
			file_name <- paste("stanfit_ku0_oa_other_", o_block, ".rds", sep = "")
		}
