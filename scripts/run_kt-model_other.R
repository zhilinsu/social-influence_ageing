...
for (pop_value in pop_vec) {
	...
	model_file <- "scripts/stan_model/kt-model_other.stan"
	...
	for (o_block in c("i", "p")) { # other blocks 
		...
		if (pop == 0) {
			file_name <- paste("stanfit_kt_other_", o_block, ".rds", sep = "")
		} else if (pop == 1) {
			file_name <- paste("stanfit_kt_ya_other_", o_block, ".rds", sep = "")
		} else if (pop == 2) {
			file_name <- paste("stanfit_kt_oa_other_", o_block, ".rds", sep = "")
		}
